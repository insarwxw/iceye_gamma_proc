...
usage: resample_slc.py [-h] [--directory DIRECTORY]
    [--out_directory OUT_DIRECTORY] slc prf
...
def main() -> None:
    ...
    parser.add_argument('slc', type=str,  help='Input SLC.')
    ...
    # - Azimuth line time: time between SLC image lines in the resampled SLC [s]
    azimuth_line_time = 1 / prf
    # - New Azimuth pixel spacing [m]
    azimuth_pixel_spacing *= (slc_az_prf / prf)

    # - Compute time duration of the original SLC derived from the start_time

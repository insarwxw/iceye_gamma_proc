...
def main():
    def main():
        ...
        pg.base_orbit(ref_slc+'.par', sec_slc+'.par',
                      f'base{ref_slc}-{sec_slc}.dat')

        # - Add Shebang line to bat file
        with open(f'./bat_inter.{ref_slc}-{sec_slc}', 'r') as b_fid:
            bat_lines = b_fid.readlines()
        with open(f'./bat_inter.{ref_slc}-{sec_slc}', 'w') as b_fid:
        ...
        os.system(f'./bat_inter.{ref_slc}-{sec_slc}')

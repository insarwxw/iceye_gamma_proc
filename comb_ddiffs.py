...
def main():
    ...
    for ddiff in dir_1_listr[:2]:
        ...
        ddiff_1 = os.path.join(dir_1, ddiff_name, 'coco'+ddiff_name.replace('--', '-') + '.flat.topo_off.geo.filt')
        ddiff_2 = os.path.join(dir_2, ddiff_name, 'coco'+ddiff_name.replace('--', '-') + '.flat.topo_off.geo.filt')
        base_1 = os.path.join(dir_1, ddiff_name, 'base'+ddiff_name.replace('--', '-') + '.flat.topo_off.geo')
        base_2 = os.path.join(dir_2, ddiff_name, 'base' + ddiff_name.replace('--', '-') + '.flat.topo_off.geo')
        ...
        out_diff = os.path.join(out_dir, 'coco'+ddiff_name.replace('--', '-') + '.flat.topo_off.geo')
